...
import { orderBurger } from '../features/burger/burger.action'
  ...
  return (
    <>
        <div className='container flex flex-col gap-10 m-20 w-[350px] h-[450px] rounded-xl bg-emerald-100 shadow-2xl'>
            ...
            <h3 className="state m-auto text-4xl">{props.burgerBase}</h3>
            ...
            onClick={props.orderBurger}>Order Burger</button>
        </div>
